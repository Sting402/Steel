              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="form-group mb-20">
                    <input
                      ...
                      name="email"
                      class="form-control"
                      :placeholder="rtl ? 'البريد الالكترونى *' : '電子郵件 *'"
                ...
                <div class="col-lg-12">
                  <div class="form-group mb-20">
                    <select
                      class="form-select"
                      :value="rtl ? 'كيف يمكننا مساعدتك ؟' : '問題選項 *'"
                      name="option"
                      @change="handleFormOptionChange"
                    >
                      <option value="問題選項">
                        {{ rtl ? "كيف يمكننا مساعدتك ؟" : "問題選項" }}
                      </option>
                      <option value="option 1">
                        {{ rtl ? "الاختيار الاول" : "產品問題" }}
                      </option>
                      <option value="option 2">
                        {{ rtl ? "الاختيار الثاني" : "其他問題" }}
                      </option>
                    </select>
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="form-group">
                    <textarea
                      ...
                      name="message"
                      class="form-control"
                      :placeholder="rtl ? 'كيف يمكننا مساعدتك ؟' : '訊息內容 *'"
